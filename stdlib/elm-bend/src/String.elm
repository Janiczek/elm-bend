...
length string =
    case string of
        EmptyString -> 0
        ConsString _ rest -> 1 + length rest
...
reverse =
    case string of
        EmptyString -> ""
        ConsString char rest -> reverse rest ++ fromChar char
...
append s1 s2 =
    case s1 of
        EmptyString -> s2
        ConsString char rest -> ConsString char (append rest s2)
...
map fn s =
    case s of
        EmptyString -> ""
        ConsString char rest -> ConsString (fn char) (map fn rest)
